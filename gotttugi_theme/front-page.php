...
<body class="main">  
  ...
  <div id="fullpage">
    ...
    <div class="section_corporation1 section fp-auto-height" id="content">
      <section class="section--corporation">
        <div class="full-bg">
          <video
            data-autoplay
            muted
    ...
    <div class="section_corporation2 section fp-auto-height">
      <section class="section--corporation section--corporation--last">
        <div class="full-bg">
          <video
            data-autoplay
            muted
