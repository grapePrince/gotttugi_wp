...
<section class="banner">
	...
	<div class="sliderWrap">
		<img
			src="<?php echo( esc_url( BASE_URI . '/images/banner_1.jpg' ) ); ?>"
			alt="진라면 호안미로 30주년 스페셜 에디션"
		/>
		<img
			src="<?php echo( esc_url( BASE_URI . '/images/banner_2.jpg' ) ); ?>"
			alt="진짜쫄면 쫄깃해 맛있어 탱글해! 올 여름에도 진짜쫄면"
		/>
		<img
			src="<?php echo( esc_url( BASE_URI . '/images/banner_3.jpg' ) ); ?>"
			alt="세상 어떤 맛보다 카레의 기억은 길다. 오뚜기 카레가 50년이 되었습니다."
		/>
		<img
			src="<?php echo( esc_url( BASE_URI . '/images/banner_4.jpg' ) ); ?>"
...
<section class="section--corporation section_corporation1" id="content">
	<div class="full-bg">
		<video
			...
			muted
			loop
			poster="<?php echo( esc_url( BASE_URI . '/images/corporation_thumnail_1.jpg' ) ); ?>"
		>
...
<section class="new_product">
	...
	>
		...
		<div class="layout_row--product__image">
			<img 
			  src="<?php echo( esc_url( BASE_URI . '/images/newproduct_main.png' ) ); ?>"
				alt="훠궈 마라탕소스" 
			/>
		</div>
		...
		<div class="row--between layout_row--desc container">
			<div class="new_product_section__desc1 gallery--item_fit layout_row--desc__item">
				...
				<img
					...
					src="<?php echo( esc_url( BASE_URI . '/images/newproduct_desc_left.jpg' ) ); ?>"
					alt="맛있는 마라탕"
				/>
			</div>
			<div class="new_product_section__desc2 gallery--item_fit layout_row--desc__item">
				...
				<img
					class="gallery--item_fit__image"
					src="<?php echo( esc_url( BASE_URI . '/images/newproduct_desc_right.jpg' ) ); ?>"
					alt="맛있는 마라국수"
				/>
			</div>
		</div>
	...
	<div class="swiper-container">
			<div class="swiper-wrapper slider__wrapper slider__wrapper--news">
				<div class="swiper-slide slider__wrapper__slide">
					<img 
						class="news_image_1" 
						src="<?php echo( esc_url( BASE_URI . '/images/event_1.jpg' ) ); ?>"
						alt="" 
					/>
				</div>
				...
				<div class="swiper-slide slider__wrapper__slide">
					<img 
						class="news_image_1" 
						src="<?php echo( esc_url( BASE_URI . '/images/event_2.jpg' ) ); ?>"
						alt="" 
					/>
				</div>
				<div class="swiper-slide slider__wrapper__slide">
				...
				<div class="swiper-slide slider__wrapper__slide">
					<img 
						class="news_image_1" 
						src="<?php echo( esc_url( BASE_URI . '/images/event_3.jpg' ) ); ?>"
						alt="" 
					/>
					</div>
			</div>
	...
	<div class="popular__main">
		<div class="container popular__main__container">
			<div class="popular__main__image">
				<img 
					src="<?php echo( esc_url( BASE_URI . '/images/popular_main.png' ) ); ?>"
					alt="진라면" 
				/>
				<img 
					class="popular__main__image__ramen" 
					src="<?php echo( esc_url( BASE_URI . '/images/popular_main2.png' ) ); ?>"
					alt="그릇에담긴라면" 
				/>
			</div>
...
<section class="recipe container l_recipe">
	...
	<div class="l_recipe__main">
		<img 
			class="l_recipe__main__image s_recipe__main__image"
			src="<?php echo( esc_url( BASE_URI . '/images/receipe_main.jpg' ) ); ?>"
			alt="닭곰탕 사진"
		/>
		<div class="l_recipe__main__details s_recipe__main__details">
			...
			<div class="l_recipe__main__products">
				<div class="l_recipe__main__product s_recipe__main__product">
					<img 
						class="s_recipe__main__product__image"
						src="<?php echo( esc_url( BASE_URI . '/images/recipe_ingredient_1.png' ) ); ?>"
						alt="닭곰탕 사진"
					/>
				...
				<div class="l_recipe_main__product s_recipe__main__product">
					<img 
						class="s_recipe__main__product__image"
						src="<?php echo( esc_url( BASE_URI . '/images/recipe_ingredient_2.png' ) ); ?>"
						alt=""
					/>
					<div class="m_button--square--border s_recipe__main__product__button">
						<div class="m_button--square--border__icon--shoplink"></div>
...
<section class="factory l_factory s_factory">
	<div class="factory__container container">
		...
		<img 
			...
			src="<?php echo( esc_url( BASE_URI . '/images/factory_back_children.png' ) ); ?>"
			alt="행복한 아이들"
		/>
	</div>
</section>
				...
				<div class="l_media_contents js-happy">
						<div class="l_media_item">
							<div class="l_media_item__image">
								<img 
									class="l_media_item__image_image s_media_item__image_image"
									src="<?php echo( esc_url( BASE_URI . '/images/sns_today_1.jpg' ) ); ?>"
									alt="만떡만떡"
								/>
						...
						<div class="l_media_item">
							<div class="l_media_item__image">
								<img 
									class="l_media_item__image_image s_media_item__image_image"
									src="<?php echo( esc_url( BASE_URI . '/images/sns_today_2.jpg' ) ); ?>"
									alt="만떡만떡"
								/>
								<div class="media_item__image__hover l_media_item__image__hover s_media_item__image__hover">
									<div class="l_media_item__image__hover__content s_media_item__image__hover__content">
				...
				<div class="l_media_contents js-ramen">
						...
						<div class="l_media_item">
							<div class="l_media_item__image">
								<img 
									class="l_media_item__image_image s_media_item__image_image"
									src="<?php echo( esc_url( BASE_URI . '/images/sns_today_3.jpg' ) ); ?>"
									alt="만떡만떡"
								/>
								<div class="media_item__image__hover l_media_item__image__hover s_media_item__image__hover">
									<div class="l_media_item__image__hover__content s_media_item__image__hover__content">
